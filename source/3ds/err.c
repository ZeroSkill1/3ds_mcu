...
_Noreturn void ERRF_ThrowResultNoRet(Result failure)
{
	...
	cmdbuf[0] = IPC_MakeHeader(1, 32, 0);
	_memset32_aligned(&cmdbuf[1], 0, sizeof(FatalErrorInfo));

	FatalErrorInfo *error = (FatalErrorInfo *)&cmdbuf[1];
