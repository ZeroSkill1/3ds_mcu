#ifndef _MCU_3DS_RESULT_H
#define _MCU_3DS_RESULT_H
...
#define R_DESCRANGE(res,lower,higher) (R_DESCRIPTION(res) >= lower && R_DESCRIPTION(res) <= higher)
#define R_MODULEDESCRANGE(res,module,lower,higher) (R_MODULE(res) == module && R_DESCRANGE(res,lower,higher))
