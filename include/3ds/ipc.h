#ifndef _MCU_3DS_IPC_H
#define _MCU_3DS_IPC_H
...
#define RET_OS_INVALID_IPCARG \
	{ \
		...
		cmdbuf[1] = OS_INVALID_IPC_ARGUMENT; \
		return; \
	}
...
#define CHECK_HEADER(...) \
	...
	{ \
		cmdbuf[0] = IPC_MakeHeader(0, 1, 0); \
		cmdbuf[1] = OS_INVALID_IPC_HEADER; \
		break; \
	}
...
{
	return getThreadLocalStorage()->cmdbuf;
}

static inline IPC_StaticBuffer *getThreadStaticBuffers(void)
{
	return getThreadLocalStorage()->ipc_static_buffers;
}
